...
func _process(_delta: float) -> void:
	...
	for item in grabbed_handles:
		...
		var to_handle        := to_local(handle.global_position) * _private_transform.basis.inverse()
		var to_handle_origin := handle.handle_origin.origin * _private_transform.basis.inverse()
